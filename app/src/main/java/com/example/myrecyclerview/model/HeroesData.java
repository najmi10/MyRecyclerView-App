...
public class HeroesData {
    public static String[][] data = new String[][]{
            {"Ahmad Dahlan", "Salah seorang ulama dan khatib " +
                    "terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itu, dan ibu dari K.H. Ahmad Dahlan " +
                    "adalah puteri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat " +
                    "pada masa itu. KH. Ahmad Dahlan telah mempelopori kebangkitan ummat Islam untuk menyadari nasibnya " +
            ...
            {"Ahmad Yani", "Jenderal TNI Anumerta Ahmad Yani (juga dieja Achmad Yani; lahir di Purworejo, " +
                    "Jawa Tengah, 19 Juni 1922 – meninggal di Lubang Buaya, Jakarta, 1 Oktober 1965 pada " +
                    "umur 43 tahun) adalah komandan Tentara Nasional Indonesia Angkatan Darat, dan dibunuh " +
            ...
            {"Sutomo", "Sutomo (lahir di Surabaya, Jawa Timur, 3 Oktober 1920 – meninggal di Padang Arafah," +
                    " Arab Saudi, 7 Oktober 1981 pada umur 61 tahun) lebih dikenal dengan sapaan akrab oleh " +
                    "rakyat sebagai Bung Tomo, adalah pahlawan yang terkenal karena peranannya dalam " +
            ...
            {"Ki Hadjar Dewantara", "Raden Mas Soewardi Soerjaningrat (EBI: Suwardi Suryaningrat, sejak 1922 " +
                    ...
                    "yang memberikan kesempatan bagi para pribumi untuk bisa memperoleh hak pendidikan seperti " +
            ...
            {"Mohammad Hatta", "Dr.(HC) Drs. H. Mohammad Hatta (lahir dengan nama Mohammad Athar, dikenal " +
                    "sebagai Bung Hatta; lahir di Fort de Kock (sekarang Bukittinggi, Sumatera Barat), " +
                    "Hindia Belanda, 12 Agustus 1902 – meninggal di Jakarta, 14 Maret 1980 pada umur 77 " +
                    "tahun) adalah tokoh pejuang, negarawan, ekonom, dan juga Wakil Presiden Indonesia yang " +
                    "pertama. Ia bersama Soekarno memainkan peranan penting untuk memerdekakan bangsa " +
                    "Indonesia dari penjajahan Belanda sekaligus memproklamirkannya pada 17 Agustus 1945. " +
                    "Ia juga pernah menjabat sebagai Perdana Menteri dalam Kabinet Hatta I, Hatta II, dan " +
                    "RIS. Ia mundur dari jabatan wakil presiden pada tahun 1956, karena berselisih dengan " +
                    "Presiden Soekarno. Hatta juga dikenal sebagai Bapak Koperasi Indonesia.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/VP_Hatta.jpg/330px-VP_Hatta.jpg"},

            {"Soedirman", "Jenderal Besar Raden Soedirman (EYD: Sudirman; lahir 24 Januari 1916 – meninggal " +
                    "29 Januari 1950 pada umur 34 tahun) adalah seorang perwira tinggi Indonesia pada masa Revolusi " +
                    ...
                    "Muhammadiyah. Saat di sekolah menengah, Soedirman mulai menunjukkan kemampuannya dalam memimpin " +
                    "dan berorganisasi, dan dihormati oleh masyarakat karena ketaatannya pada Islam. Setelah berhenti " +
                    ...
                    "menjadi pemimpin Kelompok Pemuda Muhammadiyah pada tahun 1937. Setelah Jepang menduduki Hindia " +
                    "Belanda pada 1942, Soedirman tetap mengajar. Pada tahun 1944, ia bergabung dengan tentara Pembela " +
                    "Tanah Air (PETA) yang disponsori Jepang, menjabat sebagai komandan batalion di Banyumas. Selama " +
                    "menjabat, Soedirman bersama rekannya sesama prajurit melakukan pemberontakan, namun kemudian " +
                    "diasingkan ke Bogor.",
                    "https://upload.wikimedia.org/wikipedia/commons/b/be/Col_Gatot_Subroto%2C_Kenang-Kenangan_Pada_Panglima_Besar_Letnan_Djenderal_Soedirman%2C_p27.jpg"},
            ...
            {"Soekarno", "Dr. (H.C.) Ir. H. Soekarno (ER, EYD: Sukarno, nama lahir: Koesno Sosrodihardjo) " +
                    ...
                    "69 tahun) adalah Presiden pertama Republik Indonesia yang menjabat pada periode 1945–1967. " +
                    ...
                    "tanggal 17 Agustus 1945. Soekarno adalah yang pertama kali mencetuskan konsep mengenai Pancasila " +
            ...
            {"Soepomo", "Prof. Mr. Dr. Soepomo (Ejaan Soewandi: Supomo; lahir di Sukoharjo, Jawa Tengah, " +
                    ...
                    "1945, bersama dengan Muhammad Yamin dan Soekarno.",
            ...
            {"Tan Malaka", "Tan Malaka atau Ibrahim gelar Datuk Sutan Malaka (lahir di Nagari Pandam Gadang, " +
                    ...
                    "Indonesia, tokoh Partai Komunis Indonesia, juga pendiri Partai Murba, dan merupakan salah satu " +
